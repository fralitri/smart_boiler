...
class SmartBoilerConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        data_schema = vol.Schema({
            ...
            vol.Required("electric_consumption_standby_entity"): selector.EntitySelector(
                selector.EntitySelectorConfig(domain="sensor", device_class="power")
            ),
            vol.Required("electric_consumption_hot_water_entity"): selector.EntitySelector(
                selector.EntitySelectorConfig(domain="sensor", device_class="power")
            ),
            vol.Required("electric_consumption_heating_entity"): selector.EntitySelector(
                selector.EntitySelectorConfig(domain="sensor", device_class="power")
            ),
...
class SmartBoilerOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input=None):
        ...
        data_schema = vol.Schema({
            ...
            vol.Required("electric_consumption_standby_entity", default=self.config_entry.options.get("electric_consumption_standby_entity")): selector.EntitySelector(
                selector.EntitySelectorConfig(domain="sensor", device_class="power")
            ),
            vol.Required("electric_consumption_hot_water_entity", default=self.config_entry.options.get("electric_consumption_hot_water_entity")): selector.EntitySelector(
                selector.EntitySelectorConfig(domain="sensor", device_class="power")
            ),
            vol.Required("electric_consumption_heating_entity", default=self.config_entry.options.get("electric_consumption_heating_entity")): selector.EntitySelector(
                selector.EntitySelectorConfig(domain="sensor", device_class="power")
            ),
            ...
            vol.Optional("max_heating_water_temp", default=self.config_entry.options.get("max_heating_water_temp")): vol.Coerce(float),  # Temperatura massima di esercizio acqua riscaldamento
            vol.Optional("max_hot_water_temp", default=self.config_entry.options.get("max_hot_water_temp")): vol.Coerce(float),  # Temperatura massima di esercizio acqua sanitaria
        })
